    ...
    <div class="container">
		<div class="jumbotron">
		  <div class="page-header">
			<h1 style="color: #ce4e4e;">Restricted Access</h1>
		  </div>	
		  <p style="color: #f47373;">You are not allowed to access this system</p>
		</div>
    </div>
		...
		if (localStorage.clientName != undefined) {
			...
			$.ajax({
				...
				success: function(data, status) {
					...
					if (data == 'granted') window.location.href = localStorage.href;
