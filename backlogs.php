...
<html lang="en">
  ...
  <body ng-app="appBacklogs" ng-controller="appBacklogsCtrl">
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="backlogs.php">Backlogs</a></li>
	  ...
	  <div class="row">
		<div class="col-lg-12">
			<form class="form-inline">
			  ...
			  <button type="button" class="btn btn-primary" ng-click="queryBacklogs()">Query</button>
			  <div class="form-group">
				...
				<table class="table table-striped">
					...
					<tbody>
						<tr dir-paginate="result in results | filter: view.id | itemsPerPage: pageSize" current-page="currentPage">
							<td>{{result.machine}}</td><td>{{result.location}}</td><td>{{result.pers_id}}</td><td>{{result.date}}</td><td>{{result.log}}</td><td></td>
						</tr>
					</tbody>
					<tfoot>
	...
	<script src="controllers/appBacklogs.js"></script>
  </body>
</html>